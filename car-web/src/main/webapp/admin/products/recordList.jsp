						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="cheId" size="15" value="" id="Form1_userName2" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									</td>
							...
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									出车时间：</td>
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="start1" size="15" value="" id="start1" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/> ----
									<input type="text" name="start2" size="15" value="" id="start2" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>
								</td>

								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									回来时间：</td>
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="end1" size="15" value="" id="end1" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" /> ----
									<input type="text" name="end2" size="15" value="" id="end2" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>
								</td>
							</tr>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${recordPageResult.list}" var="record">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="10%">${record.kaichushijian}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="5%">${record.huilaishijian}</td>
										...
										<c:if test="${recordPageResult.totalPage != 0 }">
											<c:forEach begin="1" end="${recordPageResult.totalPage}" var="p">
												<a href="${pageContext.request.contextPath }/RecordListServlet?page=${p}">
													<%--加入判断--%>
													<c:choose>
														<c:when test="${recordPageResult.currentPage eq p}"><span style="color: red">${p}</span></c:when>
