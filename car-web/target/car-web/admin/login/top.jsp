	...
	<script type="text/javascript">
		function exitSys() {
			if(window.confirm("确认退出系统吗?")){
				...
				window.parent.location="${pageContext.request.contextPath}/admin/login/login.jsp";
			}
		}
	</script>
</HEAD>
...
<table width="100%" height="70%" border="0" cellspacing="0"
	...
	<tr>
		...
		<td width="100%" ><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 33pt;">车辆管理系统</div></td>
	</tr>
</table>
