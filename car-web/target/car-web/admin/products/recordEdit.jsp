...
<body onload="setProductCategory('${record.shiyou}', '${record.cheId }')">
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/UpdateRecordServlet" method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" width="200px">
					<input type="text" width="100%" name="huilaishijian" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" class="bg" value="${record.huilaishijian}"/>
				</td>
			</tr>
